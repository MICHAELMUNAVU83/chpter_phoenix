defmodule ChpterPhoenixWeb.OrderLiveTest do
  use ChpterPhoenixWeb.ConnCase

  import Phoenix.LiveViewTest
  import ChpterPhoenix.OrdersFixtures

  @create_attrs %{phone_number: "some phone_number", customer_name: "some customer_name", customer_email: "some customer_email", delivery_location: "some delivery_location"}
  ...
  describe "Index" do
    ...
    test "lists all orders", %{conn: conn, order: order} do
      ...
      assert html =~ order.phone_number
    end

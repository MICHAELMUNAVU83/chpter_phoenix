defmodule ChpterPhoenixWeb.TransactionController do
  use ChpterPhoenixWeb, :controller

  alias ChpterPhoenix.Transactions
  alias ChpterPhoenix.Transactions.Transaction

  action_fallback ChpterPhoenixWeb.FallbackController
